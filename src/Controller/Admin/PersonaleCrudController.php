 ...
 */
    ...
    public function configureFields(string $pageName): iterable
    {
            ...
            $azie = AssociationField::new('azienda', 'Azienda')->onlyOnIndex();
...
//  
            ...
            if (Crud::PAGE_INDEX === $pageName) {
                return [$matr, $fullName, $photoFile, $eta, $isAtt,  $azie,  $cant, $mans, $pianoOreCantieri, $planHW, $stringTotalHourWeek ];
