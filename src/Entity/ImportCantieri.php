...
use App\Repository\ImportCantieriRepository;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\HttpFoundation\File\File;
use Symfony\Component\Validator\Constraints as Assert;

/**
 * @ORM\Entity(repositoryClass=ImportCantieriRepository::class)
 * @ORM\HasLifecycleCallbacks()
 * @Assert\Callback({"App\Validator\ImportCantieriValidator", "validate"})  
 */
class ImportCantieri
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
