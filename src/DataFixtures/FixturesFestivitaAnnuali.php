...
class FixturesFestivitaAnnuali extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $festivita->setDateFestivita(['0101 Capodanno', '0601 Befana', '0404 Pasqua', '0504 Lunedì dell\'Angelo', '2504 Festa della liberazione', '0105 Festa dei lavoratori', '0206 Festa della Repubblica', '1508 Ferragosto', '1410 San Faustino', '0111 Tutti i Santi', '0812 Festa dell\'Immacolata Concezione', '2512 Natale', '2612 Santo Stefano']);
